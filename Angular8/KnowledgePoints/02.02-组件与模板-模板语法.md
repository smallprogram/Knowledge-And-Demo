...
- [模板语法](#模板语法)
  ...
  - [绑定语法概览](#绑定语法概览)
    - [新思维模型HTML+](#新思维模型html)
    - [HTML attribute和DOM property对比](#html-attribute和dom-property对比)
    - [绑定目标](#绑定目标)
  - [属性名绑定[属性名]](#属性名绑定属性名)
    - [单项输入](#单项输入)
    - [绑定目标](#绑定目标-1)
    ...
    - [属性绑定还是插值表达式？](#属性绑定还是插值表达式)
      - [内容安全](#内容安全)
  - [attribute、class、style绑定](#attributeclassstyle绑定)
    - [attribute绑定](#attribute绑定)
    - [CSS类绑定](#css类绑定)
    - [样式绑定](#样式绑定)
  - [事件绑定](#事件绑定)
    - [目标事件](#目标事件)
    - [$event和事件处理语句](#event和事件处理语句)
    - [使用EventEmitter实现自定义事件](#使用eventemitter实现自定义事件)
    - [模板语句有副作用](#模板语句有副作用)
  - [双向绑定（[(...)]）](#双向绑定)
    - [双向绑定的原理](#双向绑定的原理)
  - [内置指令](#内置指令)
